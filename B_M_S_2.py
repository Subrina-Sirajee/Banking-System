...
def DB(): #Date of Birth
    while True:
        ...
        if isValidDate:
            ...
            print("Invalid date of birth. Please enter a date which is in day/month/year format and containing only numbers and '/' symbol.")
